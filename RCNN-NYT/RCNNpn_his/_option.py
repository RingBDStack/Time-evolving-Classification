...
BATCH_SIZE = 128
EVAL_BATCH_SIZE = 512
EMEBEDDING_DIMENSION = 100  # e
CONTEXT_DIMENSION = 100 # c
FEATURE_SIZE = 200 # H
MAX_CKPT_PERIOD = 500 #1000 #3000 # Dimensionality of character embedding
NUM_EPOCHS = 500  # Number of epochs to run.
MIN_CKPTS = 1
SUMMARY_PERIOD = 30

NUM_CLASSES = 26
SEQUENCE_LEN = 30   # median size



PARAMETERS_SMOOTHNESS = 0.01 # model parameters smoothness
