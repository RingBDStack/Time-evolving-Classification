...
class Model(object):
    ...
    def get_paramaters_list_reshape(self):
        paramaters_list_reshape = []
        for i in range(0, len(self._paramaters_list)):
            para = self._paramaters_list[i]
            paramaters_list_reshape.append(tf.reshape(para, [-1]))
        return paramaters_list_reshape
